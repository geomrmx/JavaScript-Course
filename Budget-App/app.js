...
var budgetController = (function() {
  ...
  return {
    ...
    calculateBudget: function() {
      ...
      // Calculate the spent percentage of income
...
var UIController = (function() {
  ...
  return {
    ...
    displayPercentages: function(percetnages) {
      ...
      nodeListForEach(fields, function(current, index) {
        if (percetnages[index] > 0) {
          current.textContent = percetnages[index] + "%";
        } else {
          current.textContent = "---";
        }
      });
...
var controller = (function(budgetCtrl, UICtrl) {
  ...
  var updatePercentages = function() {
    ...
    var percetnages = budgetCtrl.getPercentages();

    // 3. Update the UI with the new percentages
    UICtrl.displayPercentages(percetnages);
  };
  ...
  var ctrlAddItem = function() {
    ...
    if (input.desciption !== "" && !isNaN(input.value) && input.value > 0) {
      ...
      // 6. Calculate and update percetnages
      updatePercentages();
    }
  };
  ...
  var ctrlDeleteItem = function(event) {
    ...
    if (itemID) {
      ...
      // 4. Calculate and update percetnages
      updatePercentages();
    }
  };
